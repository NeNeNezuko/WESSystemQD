...
/// 对应数据库 db_gz01.API_ACTION_HIS_I 表
/// </summary>
public class ApiActionHisI
{
    /// <summary>日志代号</summary>
    public long? HIS_NO { get; set; }
    /// <summary>处理动作(Add/Push/Redo/Delete)</summary>
    public string? ACT_ID { get; set; }
    /// <summary>处理代号</summary>
